...
<body>
	<div id="page_container">
		<div id="content-wrap">
			...
			<div class="login">
				<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST" name="loginForm" class="login-form">
					<h2 class="review-text">Login</h2>
					<input type="text" id="username-login-page" name="username" placeholder="username" autocomplete="off" />
					...
					<input type="password" id="password-login-page" name="password" placeholder="password" autocomplete="off">
